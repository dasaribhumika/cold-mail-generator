...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Bhumika Dasari, a tech enthusiast and Master's student in Computer Science at Syracuse University. You are passionate about 
            AI/GenAI and have experience as a Software Developer. Currently, you are working as a Graduate Research Assistant, where you are 
            involved in developing digital literacy workshops and analyzing data to empower underserved communities. 
